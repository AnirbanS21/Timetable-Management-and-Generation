...
%>
  ...
  <tr>
    <th>Monday</th>
    <th>
        <% ResultSet mon1=st.executeQuery("select * from timetable where ddid=1 and divi='SEA'");
            while(mon1.next())
            {
                    %>
    ...
    <th>
        <% ResultSet mon2=st.executeQuery("select * from timetable where ddid=2 and divi='SEA'");
            while(mon2.next())
            {
                    %>
    ...
    <th>
        <% ResultSet mon3=st.executeQuery("select * from timetable where ddid=3 and divi='SEA'");
            while(mon3.next())
            {
                    %>
    ...
    <th>
    <% ResultSet mon4=st.executeQuery("select * from timetable where ddid=4 and divi='SEA'");
            while(mon4.next())
            {
                    %>
    ...
    <th>
    <% ResultSet mon5=st.executeQuery("select * from timetable where ddid=5 and divi='SEA'");
            while(mon5.next())
            {
                    %>
    ...
    <th>
    <% ResultSet mon6=st.executeQuery("select * from timetable where ddid=6  and divi='SEA'");
            while(mon6.next())
            {
                    %>
  ...
  <tr>
    <th>Tuesday</th>
    <th>
    <% ResultSet tue1=st.executeQuery("select * from timetable where ddid=9  and divi='SEA'");
            while(tue1.next())
            {
                    %>
    ...
    <th>
    <% ResultSet tue3=st.executeQuery("select * from timetable where ddid=11  and divi='SEA'");
            while(tue3.next())
            {
                    %>
    ...
    <th>
    <% ResultSet tue4=st.executeQuery("select * from timetable where ddid=12  and divi='SEA'");
            while(tue4.next())
            {
                    %>
    ...
    <th>
    <% ResultSet tue5=st.executeQuery("select * from timetable where ddid=13  and divi='SEA'");
            while(tue5.next())
            {
                    %>
    ...
    <th>
    <% ResultSet tue6=st.executeQuery("select * from timetable where ddid=14  and divi='SEA'");
            while(tue6.next())
            {
                    %>
  ...
  <tr>
    <th>Wednesday</th>
    <th>
    <% ResultSet wed1=st.executeQuery("select * from timetable where ddid=17  and divi='SEA'");
            while(wed1.next())
            {
                    %>
    ...
    <th>
    <% ResultSet wed2=st.executeQuery("select * from timetable where ddid=18  and divi='SEA'");
            while(wed2.next())
            {
                    %>
    ...
    <th>
    <% ResultSet wed3=st.executeQuery("select * from timetable where ddid=19  and divi='SEA'");
            while(wed3.next())
            {
                    %>
    ...
    <th>
    <% ResultSet wed4=st.executeQuery("select * from timetable where ddid=20  and divi='SEA'");
            while(wed4.next())
            {
                    %>
    ...
    <th>
    <% ResultSet wed5=st.executeQuery("select * from timetable where ddid=21  and divi='SEA'");
            while(wed5.next())
            {
                    %>
  ...
  <tr>
    <th>Thursday</th>
    <th>
    <% ResultSet thu1=st.executeQuery("select * from timetable where ddid=25  and divi='SEA'");
            while(thu1.next())
            {
                    %>
    ...
    <th>
    <% ResultSet thu2=st.executeQuery("select * from timetable where ddid=26  and divi='SEA'");
            while(thu2.next())
            {
                    %>
    ...
    <th>
    <% ResultSet thu3=st.executeQuery("select * from timetable where ddid=27  and divi='SEA'");
            while(thu3.next())
            {
                    %>
    ...
    <th>
    <% ResultSet thu4=st.executeQuery("select * from timetable where ddid=28  and divi='SEA'");
            while(thu4.next())
            {
                    %>
    ...
    <th>
    <% ResultSet thu5=st.executeQuery("select * from timetable where ddid=29  and divi='SEA'");
            while(thu5.next())
            {
                    %>
    ...
    <th>
    <% ResultSet thu6=st.executeQuery("select * from timetable where ddid=30  and divi='SEA'");
            while(thu6.next())
            {
                    %>
  ...
  <tr>
    <th>Friday</th>
    <th>
    <% ResultSet fri1=st.executeQuery("select * from timetable where ddid=33  and divi='SEA'");
            while(fri1.next())
            {
                    %>
    ...
    <th>
    <% ResultSet fri2=st.executeQuery("select * from timetable where ddid=34  and divi='SEA'");
            while(fri2.next())
            {
                    %>
    ...
    <th>
    <% ResultSet fri3=st.executeQuery("select * from timetable where ddid=35  and divi='SEA'");
            while(fri3.next())
            {
                    %>
    ...
    <th>
    <% ResultSet fri4=st.executeQuery("select * from timetable where ddid=36  and divi='SEA'");
            while(fri4.next())
            {
                    %>
    ...
    <th>
    <% ResultSet fri5=st.executeQuery("select * from timetable where ddid=37  and divi='SEA'");
            while(fri5.next())
            {
                    %>
    ...
    <th>
    <% ResultSet fri6=st.executeQuery("select * from timetable where ddid=38  and divi='SEA'");
            while(fri6.next())
            {
                    %>
  ...
  <tr>
    <th>Saturday</th>
    <th>
    <% ResultSet sat1=st.executeQuery("select * from timetable where ddid=41  and divi='SEA'");
            while(sat1.next())
            {
                    %>
    ...
    <th>
    <% ResultSet sat2=st.executeQuery("select * from timetable where ddid=42  and divi='SEA'");
            while(sat2.next())
            {
                    %>
    ...
    <th>
    <% ResultSet sat3=st.executeQuery("select * from timetable where ddid=43  and divi='SEA'");
            while(sat3.next())
            {
                    %>
    ...
    <th>
    <% ResultSet sat4=st.executeQuery("select * from timetable where ddid=44  and divi='SEA'");
            while(sat4.next())
            {
                    %>
    ...
    <th>
    <% ResultSet sat5=st.executeQuery("select * from timetable where ddid=45  and divi='SEA'");
            while(sat5.next())
            {
                    %>
    ...
    <th>
    <% ResultSet sat6=st.executeQuery("select * from timetable where ddid=46  and divi='SEA'");
            while(sat6.next())
            {
                    %>
...
*/%>
  ...
  <form class="box2" action="collisionSEA.jsp">
        SUBJECT:
