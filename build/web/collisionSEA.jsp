...
<%
    ...
    String div="SEa";
     Class.forName("com.mysql.jdbc.Driver");
      ...
      ResultSet fac= st.executeQuery("select * from teach where subcode='"+subcode+"' and class_div='SEA'");
      String tag=null;
      while(fac.next())
      {
      ...
      if(cat.equals("class"))
      { 
        ResultSet insert= st.executeQuery("select * from timetable where ddid='"+ddid+"' and (divi='SEa' or room_no='"+room+"' or tag='"+tag+"')");
        while(insert.next())
      {
...
//int        
        ...
        if(d.equals("SEa") )
      {
            ...
            out.println("location='display_tableSEa.jsp'");
            out.println("</script>");
...
//int        
      ...
      if(r!=null && t!=null)
        ...
        else
        {
            ...
            ResultSet c=st.executeQuery("select count(*) from timetable where subcode='"+subcode+"' and divi='SEA'");
            while(c.next())
