...
%>
  ...
  <tr>
    <th>Monday</th>
    <th>
        <% ResultSet mon1=st.executeQuery("select * from timetable where ddid=3 and divi='TEB'");
            while(mon1.next())
            {
                    %>
    ...
    <th>
        <% ResultSet mon2=st.executeQuery("select * from timetable where ddid=4 and divi='TEB'");
            while(mon2.next())
            {
                    %>
    ...
    <th>
        <% ResultSet mon3=st.executeQuery("select * from timetable where ddid=5 and divi='TEB'");
            while(mon3.next())
            {
                    %>
    ...
    <th>
    <% ResultSet mon4=st.executeQuery("select * from timetable where ddid=6 and divi='TEB'");
            while(mon4.next())
            {
                    %>
    ...
    <th>
    <% ResultSet mon5=st.executeQuery("select * from timetable where ddid=7 and divi='TEB'");
            while(mon5.next())
            {
                    %>
    ...
    <th>
    <% ResultSet mon6=st.executeQuery("select * from timetable where ddid=8  and divi='TEB'");
            while(mon6.next())
            {
                    %>
  ...
  <tr>
    <th>Tuesday</th>
    <th>
    <% ResultSet tue1=st.executeQuery("select * from timetable where ddid=11  and divi='TEB'");
            while(tue1.next())
            {
                    %>
    ...
    <th>
    <% ResultSet tue2=st.executeQuery("select * from timetable where ddid=12 and divi='TEB' ");
            while(tue2.next())
            {
                    %>
    ...
    <th>
    <% ResultSet tue3=st.executeQuery("select * from timetable where ddid=13  and divi='TEB'");
            while(tue3.next())
            {
                    %>
    ...
    <th>
    <% ResultSet tue4=st.executeQuery("select * from timetable where ddid=14  and divi='TEB'");
            while(tue4.next())
            {
                    %>
    ...
    <th>
    <% ResultSet tue5=st.executeQuery("select * from timetable where ddid=15  and divi='TEB'");
            while(tue5.next())
            {
                    %>
    ...
    <th>
    <% ResultSet tue6=st.executeQuery("select * from timetable where ddid=16  and divi='TEB'");
            while(tue6.next())
            {
                    %>
  ...
  <tr>
    <th>Wednesday</th>
    <th>
    <% ResultSet wed1=st.executeQuery("select * from timetable where ddid=19  and divi='TEB'");
            while(wed1.next())
            {
                    %>
    ...
    <th>
    <% ResultSet wed2=st.executeQuery("select * from timetable where ddid=20  and divi='TEB'");
            while(wed2.next())
            {
                    %>
    ...
    <th>
    <% ResultSet wed3=st.executeQuery("select * from timetable where ddid=21  and divi='TEB'");
            while(wed3.next())
            {
                    %>
    ...
    <th>
    <% ResultSet wed4=st.executeQuery("select * from timetable where ddid=22  and divi='TEB'");
            while(wed4.next())
            {
                    %>
    ...
    <th>
    <% ResultSet wed5=st.executeQuery("select * from timetable where ddid=23  and divi='TEB'");
            while(wed5.next())
            {
                    %>
    ...
    <th>
    <% ResultSet wed6=st.executeQuery("select * from timetable where ddid=24 and divi='TEB' ");
            while(wed6.next())
            {
                    %>
  ...
  <tr>
    <th>Thursday</th>
    <th>
    <% ResultSet thu1=st.executeQuery("select * from timetable where ddid=27  and divi='TEB'");
            while(thu1.next())
            {
                    %>
    ...
    <th>
    <% ResultSet thu2=st.executeQuery("select * from timetable where ddid=28  and divi='TEB'");
            while(thu2.next())
            {
                    %>
    ...
    <th>
    <% ResultSet thu3=st.executeQuery("select * from timetable where ddid=29  and divi='TEB'");
            while(thu3.next())
            {
                    %>
    ...
    <th>
    <% ResultSet thu4=st.executeQuery("select * from timetable where ddid=30  and divi='TEB'");
            while(thu4.next())
            {
                    %>
    ...
    <th>
    <% ResultSet thu5=st.executeQuery("select * from timetable where ddid=31  and divi='TEB'");
            while(thu5.next())
            {
                    %>
    ...
    <th>
    <% ResultSet thu6=st.executeQuery("select * from timetable where ddid=32  and divi='TEB'");
            while(thu6.next())
            {
                    %>
  ...
  <tr>
    <th>Friday</th>
    <th>
    <% ResultSet fri1=st.executeQuery("select * from timetable where ddid=35  and divi='TEB'");
            while(fri1.next())
            {
                    %>
    ...
    <th>
    <% ResultSet fri2=st.executeQuery("select * from timetable where ddid=36  and divi='TEB'");
            while(fri2.next())
            {
                    %>
    ...
    <th>
    <% ResultSet fri3=st.executeQuery("select * from timetable where ddid=37  and divi='TEB'");
            while(fri3.next())
            {
                    %>
    ...
    <th>
    <% ResultSet fri4=st.executeQuery("select * from timetable where ddid=38  and divi='TEB'");
            while(fri4.next())
            {
                    %>
    ...
    <th>
    <% ResultSet fri5=st.executeQuery("select * from timetable where ddid=39  and divi='TEB'");
            while(fri5.next())
            {
                    %>
    ...
    <th>
    <% ResultSet fri6=st.executeQuery("select * from timetable where ddid=40  and divi='TEB'");
            while(fri6.next())
            {
                    %>
  ...
  <tr>
    <th>Saturday</th>
    <th>
    <% ResultSet sat1=st.executeQuery("select * from timetable where ddid=43  and divi='TEB'");
            while(sat1.next())
            {
                    %>
    ...
    <th>
    <% ResultSet sat2=st.executeQuery("select * from timetable where ddid=44  and divi='TEB'");
            while(sat2.next())
            {
                    %>
    ...
    <th>
    <% ResultSet sat3=st.executeQuery("select * from timetable where ddid=45  and divi='TEB'");
            while(sat3.next())
            {
                    %>
    ...
    <th>
    <% ResultSet sat4=st.executeQuery("select * from timetable where ddid=46  and divi='TEB'");
            while(sat4.next())
            {
                    %>
    ...
    <th>
    <% ResultSet sat5=st.executeQuery("select * from timetable where ddid=47  and divi='TEB'");
            while(sat5.next())
            {
                    %>
    ...
    <th>
    <% ResultSet sat6=st.executeQuery("select * from timetable where ddid=48  and divi='TEB'");
            while(sat6.next())
            {
                    %>
...
*/%>
  ...
  <form class="box2" action="collisionTEB.jsp">
        SUBJECT:
             ...
             DAY:         <select class="dropdown" name="day">
              ...
              TIME:            <select class="dropdown" name="time">
                                ...
                                <option value="3:00">3:00-4:00</option>
                                  <option value="4:15">4:15-5:15</option>
                                <option value="5:15">5:15-6:15</option>
                          </select>
