...
<%
    ...
    String div="BEa";
     Class.forName("com.mysql.jdbc.Driver");
      ...
      ResultSet fac= st.executeQuery("select * from teach where subcode='"+subcode+"' and class_div='BEA'");
      String tag=null;
      while(fac.next())
      {
      ...
      if(cat.equals("class"))
      { 
        ResultSet insert= st.executeQuery("select * from timetable where ddid='"+ddid+"' and (divi='BEa' or room_no='"+room+"' or tag='"+tag+"')");
        while(insert.next())
      {
...
//int        
        ...
        if(d.equals("BEa") )
      {
            ...
            out.println("location='display_tableBEa.jsp'");
            out.println("</script>");
...
//int        
      ...
      if(r!=null && t!=null)
        ...
        else
        {
            ...
            ResultSet c=st.executeQuery("select count(*) from timetable where subcode='"+subcode+"' and divi='BEA'");
            while(c.next())
