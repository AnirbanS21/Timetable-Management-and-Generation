...
public final class teachBE_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Class.forName("com.mysql.jdbc.Driver");
    ...
    ResultSet s=st.executeQuery("select * from faculty where year=001 or year=011 or year=101 or year=111");
    while(s.next())
    {
    ...
    ResultSet rs=st.executeQuery("select * from subjects where year='BE'");
    while(rs.next())
    {
      ...
      out.write("    ");
        ...
        ResultSet set  = st.executeQuery("select * from teach where class_div='BEA' or class_div='BEB'");
        while(set.next())
                {
 ...
 st.executeUpdate("delete from teach where tid='null'");
            ...
            out.println(tag+" "+subject+" "+div);
           /* ResultSet r = st.executeQuery("Select subcode from subjects where subname='"+subject+"'");
            st.executeUpdate("Insert into teach(tid,tag,subcode,div) values('"+1+"'"+tag+"','"+r.getString("subcode")+"','"+div+"')");
      ...
      out.write("      }\n");
      out.write("    }\n");
      out.write("    function adRowsTable3(id){\n");
      out.write("      var table = document.getElementById(id);\n");
      out.write("      var me = this;\n");
      out.write("      if(document.getElementById(id)){\n");
      out.write("        var row1 = table.rows[1].outerHTML;\n");
