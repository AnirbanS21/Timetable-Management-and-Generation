...
%>
  ...
  <tr>
    <th>Monday</th>
    <th>
        <% ResultSet mon1=st.executeQuery("select * from timetable where ddid=3 and tag='"+tag+"'");
            while(mon1.next())
            {
                    %>
    ...
    <th>
        <% ResultSet mon2=st.executeQuery("select * from timetable where ddid=4 and tag='"+tag+"'");
            while(mon2.next())
            {
                    %>
    ...
    <th>
        <% ResultSet mon3=st.executeQuery("select * from timetable where ddid=5 and tag='"+tag+"'");
            while(mon3.next())
            {
                    %>
    ...
    <th>
        <% ResultSet mon4=st.executeQuery("select * from timetable where ddid=6 and tag='"+tag+"'");
            while(mon4.next())
            {
                    %>
    ...
    <th>
        <% ResultSet mon5=st.executeQuery("select * from timetable where ddid=7 and tag='"+tag+"'");
            while(mon5.next())
            {
                    %>
    ...
    <th>
        <% ResultSet mon6=st.executeQuery("select * from timetable where ddid=8 and tag='"+tag+"'");
            while(mon6.next())
            {
                    %>
  ...
  <tr>
    <th>Tuesday</th>
    <th>
        <% ResultSet tue1=st.executeQuery("select * from timetable where ddid=11 and tag='"+tag+"'");
            while(tue1.next())
            {
                    %>
    ...
    <th>
        <% ResultSet tue2=st.executeQuery("select * from timetable where ddid=12 and tag='"+tag+"'");
            while(tue2.next())
            {
                    %>
    ...
    <th>
        <% ResultSet tue3=st.executeQuery("select * from timetable where ddid=13 and tag='"+tag+"'");
            while(tue3.next())
            {
                    %>
    ...
    <th>
        <% ResultSet tue4=st.executeQuery("select * from timetable where ddid=14 and tag='"+tag+"'");
            while(tue4.next())
            {
                    %>
    ...
    <th>
        <% ResultSet tue5=st.executeQuery("select * from timetable where ddid=15 and tag='"+tag+"'");
            while(tue5.next())
            {
                    %>
    ...
    <th>
        <% ResultSet tue6=st.executeQuery("select * from timetable where ddid=16 and tag='"+tag+"'");
            while(tue6.next())
            {
                    %>
  ...
  <tr>
    <th>Wednesday</th>
    <th>
        <% ResultSet wed1=st.executeQuery("select * from timetable where ddid=19 and tag='"+tag+"'");
            while(wed1.next())
            {
                    %>
    ...
    <th>
        <% ResultSet wed2=st.executeQuery("select * from timetable where ddid=20 and tag='"+tag+"'");
            while(wed2.next())
            {
                    %>
    ...
    <th>
        <% ResultSet wed3=st.executeQuery("select * from timetable where ddid=21 and tag='"+tag+"'");
            while(wed3.next())
            {
                    %>
    ...
    <th>
        <% ResultSet wed4=st.executeQuery("select * from timetable where ddid=22 and tag='"+tag+"'");
            while(wed4.next())
            {
                    %>
    ...
    <th>
        <% ResultSet wed5=st.executeQuery("select * from timetable where ddid=23 and tag='"+tag+"'");
            while(wed5.next())
            {
                    %>
    ...
    <th>
        <% ResultSet wed6=st.executeQuery("select * from timetable where ddid=24 and tag='"+tag+"'");
            while(wed6.next())
            {
                    %>
  ...
  <tr>
    <th>Thursday</th>
    <th>
        <% ResultSet thu1=st.executeQuery("select * from timetable where ddid=27 and tag='"+tag+"'");
            while(thu1.next())
            {
                    %>
    ...
    <th>
        <% ResultSet thu2=st.executeQuery("select * from timetable where ddid=28 and tag='"+tag+"'");
            while(thu2.next())
            {
                    %>
    ...
    <th>
        <% ResultSet thu3=st.executeQuery("select * from timetable where ddid=29 and tag='"+tag+"'");
            while(thu3.next())
            {
                    %>
    ...
    <th>
        <% ResultSet thu4=st.executeQuery("select * from timetable where ddid=30 and tag='"+tag+"'");
            while(thu4.next())
            {
                    %>
    ...
    <th>
        <% ResultSet thu5=st.executeQuery("select * from timetable where ddid=31 and tag='"+tag+"'");
            while(thu5.next())
            {
                    %>
    ...
    <th>
        <% ResultSet thu6=st.executeQuery("select * from timetable where ddid=32 and tag='"+tag+"'");
            while(thu6.next())
            {
                    %>
  ...
  <tr>
    <th>Friday</th>
    <th>
        <% ResultSet fri1=st.executeQuery("select * from timetable where ddid=35 and tag='"+tag+"'");
            while(fri1.next())
            {
                    %>
    ...
    <th>
        <% ResultSet fri2=st.executeQuery("select * from timetable where ddid=36 and tag='"+tag+"'");
            while(fri2.next())
            {
                    %>
    ...
    <th>
        <% ResultSet fri3=st.executeQuery("select * from timetable where ddid=37 and tag='"+tag+"'");
            while(fri3.next())
            {
                    %>
    ...
    <th>
        <% ResultSet fri4=st.executeQuery("select * from timetable where ddid=38 and tag='"+tag+"'");
            while(fri4.next())
            {
               %>
    ...
    <th>
        <% ResultSet fri5=st.executeQuery("select * from timetable where ddid=39 and tag='"+tag+"'");
            while(fri5.next())
            {
                    %>
    ...
    <th>
        <% ResultSet fri6=st.executeQuery("select * from timetable where ddid=40 and tag='"+tag+"'");
            while(fri6.next())
            {
                    %>
  ...
  <tr>
    <th>Saturday</th>
    <th>
        <% ResultSet sat1=st.executeQuery("select * from timetable where ddid=43 and tag='"+tag+"'");
            while(sat1.next())
            {
                    %>
    ...
    <th>
        <% ResultSet sat2=st.executeQuery("select * from timetable where ddid=44 and tag='"+tag+"'");
            while(sat2.next())
            {
                    %>
    ...
    <th>
        <% ResultSet sat3=st.executeQuery("select * from timetable where ddid=45 and tag='"+tag+"'");
            while(sat3.next())
            {
                    %>
    ...
    <th>
        <% ResultSet sat4=st.executeQuery("select * from timetable where ddid=46 and tag='"+tag+"'");
            while(sat4.next())
            {
                    %>
    ...
    <th>
        <% ResultSet sat5=st.executeQuery("select * from timetable where ddid=47 and tag='"+tag+"'");
            while(sat5.next())
            {
                    %>
    ...
    <th>
        <% ResultSet sat6=st.executeQuery("select * from timetable where ddid=48 and tag='"+tag+"'");
            while(sat6.next())
            {
                    %>
