...
<form class="box" method="post" action="subject_insert.jsp"> 
        ...
        <h1 style="color:white">Enter the Subjects</h1>
        

    <table id="table1">
        <tr><th>ID</th><th>Subcode</th><th>Subject</th><th>Year</th><th>Limit</th><th></th></tr>
    <tr>
 ...
 <!--    <td><input type="submit" class="button" value="Add Row" name="add" onclick="ob_adRows1.addRow(this)"/></td>-->
             <td><input type="submit" class="button" value="Add Subject" /></td>
